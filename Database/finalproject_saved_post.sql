...
CREATE TABLE `saved_post` (
  ...
  KEY `user_id` (`user_id`),
  KEY `post_id` (`post_id`),
  CONSTRAINT `saved_post_ibfk1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `saved_post` VALUES (8,4,13,'2023-12-22 11:46:37');
